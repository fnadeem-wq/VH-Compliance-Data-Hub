    ...
    <>
      <section className="rounded-lg bg-white p-6 shadow-card">
        ...
        {state.selectedClientId != null && state.selectedSourceSystemId == null && (
          <section className="rounded-lg bg-white p-6 shadow-card">
            {isLoadingClientWide && (
              <p className="text-sm text-charcoal/70">Loading all records for this client…</p>
            )}
        ...
        {state.selectedSourceSystemId != null && (
          <section>
            ...
            {state.step === "APPENDING" && (
              <div className="rounded-lg bg-white p-10 text-center text-sm text-charcoal shadow-card">
                Saving standardized records…
              </div>
            )}
